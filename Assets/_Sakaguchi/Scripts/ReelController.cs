...
public class ReelController : MonoBehaviour
{
    ...
    public void TempStop(int pendingIndex)
    {
        int converted = (symbolCount + 1) - pendingIndex;
        targetIndex = (converted + 1) % symbolCount;
        isStopping = true;
        ...
        Debug.Log($"[TempStop] pendingIndex:{pendingIndex} targetIndex:{targetIndex} currentIndex:{currentIndex:F2} remaining:{remaining:F2} mustFull:{mustFullRotation}");
    }
